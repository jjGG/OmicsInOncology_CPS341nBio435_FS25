...
# Read the file
dat <- read_xlsx("C:\\Users\\rolin\\Documents\\R studio\\OmicsInOncology_CPS341nBio435_FS25(3)\\week6\\41467_2022_31810_MOESM3_ESM.xlsx")
...
ggplot(vdat, aes(x = log2Ratio, y = -log10(Pvalue))) +
  labs(x = "log2Ratio", y = "-log10(Pvalue)", title = "Volcano Plot") +
...
dat$neg_log_pvalue <- -log10(dat$Pvalue)

# Create the volcano plot
ggplot(dat, aes(x = log2Ratio, y = neg_log_pvalue)) +
  geom_point(aes(color = Pvalue < 0.05 & abs(log2Ratio) > 1), size = 4) +  # Color points based on significance
  theme_minimal() +
  labs(x = "Log2 Ratio", y = "-Log10(P-value)", title = "Volcano Plot") +
...
```
First some reshaping is necessary again.
